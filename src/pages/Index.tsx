...
const Index = () => {
  ...
  const productThumbnails: { [key: string]: string } = {
    ...
    maletas1: maletas1,
    mochila1: mochila1,
    cartucuaderno1: "/src/assets/escolar/cartuchera1.png",
    lonchera1: "/src/assets/escolar/lonchera1.png",
    crayolas1: "/src/assets/escolar/crayolas1.png",
    tablero1: "/src/assets/escolar/tablero1.png",
    lunch1: "/src/assets/escolar/lunch1.png",
    libreta1: "/src/assets/escolar/libretas1.png",
    kitlunch1: "/src/assets/escolar/kitlunch1.png",
    termo1: "/src/assets/escolar/termo1.png",
    kitarte1: "/src/assets/escolar/kitarte.png",
    marcadores1: "/src/assets/escolar/marcadores.png",
